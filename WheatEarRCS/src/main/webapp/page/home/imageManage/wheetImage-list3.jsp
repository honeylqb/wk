...
<%--            <a href="${pageContext.request.contextPath}/wheatImageController/zipfileDownload.do">moni.jpg</a>--%>
            ...
            if (obj.event === 'edit') {
                ...
                layer.open({
                    ...
                    success : function(layero, index) { // 成功弹出后回调
                        ...
                        console.log("-------------2------------------2-------------");
                        console.log(index);
                        var image = layer.getChildFrame('img', index);
                        console.log("-------------3------------------3-------------");
                        console.log(image);

                        var div = layer.getChildFrame('div', index);
                        div.find("#imageSrc").attr("src",data.compressImagePath);
                    },
                    yes : function(index, layero) { // 保存按钮回调函数
                        var form = layer.getChildFrame('form', index);  //获取iframe页的DOM
                        //layer.msg($(form).serialize());
