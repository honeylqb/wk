        ...
        <div class="layui-fluid">
            <div class="layui-row layui-col-space15">
                    ...
                    <div class="layui-card">
                        ...
                        <div class="layui-card-body" style="min-height: 300px;">
                            <div  class="layui-col-sm12" style="height: 300px;">
                                <img src="/${wheatImage.src}"  height=" 300px">
                            </div>
                ...
                <div class="layui-card">
                    ...
                    <div class="layui-card-body" style="min-height: 300px;">
                        <div  class="layui-col-sm12" style="height: 300px;">
                            <img src="/${wheatImage.src1}"  height=" 300px">
                        </div>
                ...
                <div class="layui-col-sm12 layui-col-md6">
                    <div class="layui-card">
                        ...
                        <div class="layui-card-body" style="min-height: 300px;">
                            <div  class="layui-col-sm12" style="height: 300px;">
                                <img src="/${wheatImage.src2}"  height=" 300px">
                            </div>
                ...
                <div class="layui-col-sm12 layui-col-md6">
                    <div class="layui-card">
                        ...
                        <div class="layui-card-body" style="min-height: 300px;">
                            <div  class="layui-col-sm12" style="height: 300px;">
                                <img src="/${wheatImage.src3}"  height=" 300px">
                            </div>
                ...
                <div class="layui-col-sm12 layui-col-md6">
                    <div class="layui-card">
                        ...
                        <div class="layui-card-body" style="min-height: 300px;">
                            <div  class="layui-col-sm12" style="height: 300px;">
                                <img src="/${wheatImage.src4}"  height=" 300px">
                            </div>
                ...
                <div class="layui-col-sm12 layui-col-md6">
                    <div class="layui-card">
                        ...
                        <div class="layui-card-body" style="min-height: 300px;">
                            <div  class="layui-col-sm12" style="height: 300px;">
                                <img src="/${wheatImage.src5}"  height=" 300px">
                            </div>
                ...
                <div class="layui-col-sm12 layui-col-md6">
                    <div class="layui-card">
                        ...
                        <div class="layui-card-body" style="min-height: 300px;">
                            <div  class="layui-col-sm12" style="height: 300px;">
                                <img src="/${wheatImage.src7}"  height=" 300px">
                            </div>
