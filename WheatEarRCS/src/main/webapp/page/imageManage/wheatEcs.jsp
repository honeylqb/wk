...
<script type="text/javascript">
   var tav = function () {
        parent.xadmin.open('在tab打开','${pageContext.request.contextPath}/page/home/imageManage/shibie.jsp')
    ...
    $(function () {
        ...
        $("#zyupload").zyUpload({
            ...
            url: "${pageContext.request.contextPath}/FileUploadController/fileUploadAndWheat.do",  // 上传文件的路径
