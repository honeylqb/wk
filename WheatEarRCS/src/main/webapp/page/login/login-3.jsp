            ...
            <form class="layui-form" action="">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="captcha-img">
                        <img id="captchaPic" src="${pageContext.request.contextPath}/src/layui/layuimini/images/captcha.jpg">
                    </div>
                </div>
                <div class="layui-form-item">
...
<script src="${pageContext.request.contextPath}/src/layui/layuimini/lib/jq-module/jquery.particleground.min.js" charset="utf-8"></script>
<script>
