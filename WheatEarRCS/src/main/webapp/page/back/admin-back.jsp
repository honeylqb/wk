...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/src/layui/layuimini/css/layuimini.css" media="all">
    ...
    <div class="layui-header header">
        ...
        <ul class="layui-nav layui-layout-right">
            ...
            <li class="layui-nav-item layuimini-setting">
                <a href="javascript:;">${loginUserInfo.userName}</a>
                <dl class="layui-nav-child">
                    ...
                    <dd>
                        <a href="${pageContext.request.contextPath}/loginExit.do" class="login-out">退出登录</a>
                    </dd>
                </dl>
            </li>
...
<script src="${pageContext.request.contextPath}/src/layui/layuimini/lib/layui-v2.5.4/layui.js?v=1.0.4" charset="utf-8"></script>
