            ...
            function() {
                ...
                function(data) {
                    ...
                    $.each(data.field,function (i, n) {
                        //组装数据
                        if(i!="username"&&i!="phone"&&i!="pass"&&i!="repass"&&i!="email"&&i!="userAccount"){
                    ...
                    $.ajax({
                        url:"${pageContext.request.contextPath}/UserManageController/addUser.do",
